    ...
    int       nCmdShow)
{
    ...
    return 2048Player::createAndRun();
}

int 2048Player::createAndRun(void)
{
    2048Player *host = 2048Player::sharedInstance();
    int ret = host->run();
    2048Player::purgeSharedInstance();
    return ret;
}

2048Player *2048Player::s_sharedInstance = NULL;

2048Player *2048Player::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new 2048Player();
    }
    return s_sharedInstance;
}

void 2048Player::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
int 2048Player::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "2048-player");
...
void 2048Player::loadProjectConfig(void)
{
    vector<string> args;
...
void 2048Player::createViewMenu(void)
{
...
void 2048Player::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void 2048Player::updateWindowTitle(void)
{
}

void 2048Player::relaunch(void)
{
...
void 2048Player::writeDebugLog(const char *log)
{
...
// menu callback
void 2048Player::onFileOpenProject(void)
{
...
void 2048Player::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"2048Player");
...
void 2048Player::onFileProjectConfig(void)
{
...
void 2048Player::onFileRelaunch(void)
{
    relaunch();
}

void 2048Player::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void 2048Player::onViewChangeFrameSize(int viewMenuID)
{
...
void 2048Player::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void 2048Player::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void 2048Player::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT 2048Player::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    2048Player *host = 2048Player::sharedInstance();
...
INT_PTR CALLBACK 2048Player::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
